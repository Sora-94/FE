...
import img1 from '../../assets/img/featur-1.jpg'; // Cập nhật đường dẫn ảnh theo cấu trúc của bạn
...
import img7 from '../../assets/img/fruite-item-3.jpg';
import img8 from '../../assets/img/fruite-item-4.jpg';
import img9 from '../../assets/img/fruite-item-5.jpg';
...
function IndexShop(){
    return(
        <>
        <NavbarLayout/>        {/* <!-- Single Page Header start --> */}
                            ...
                            <div className="col-lg-9">
                                <div className="row g-4 justify-content-center">
                                    ...
                                    <div className="col-md-6 col-lg-6 col-xl-4">
                                        <div className="rounded position-relative fruite-item">
                                            <div className="fruite-img">
                                                <img src={img8} className="img-fluid w-100 rounded-top" alt=""/>
                                            </div>
                                            <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{top: '10px; left: 10px'}}>Fruits</div>
                                            <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Apricots</h4>
                                    ...
                                    <div className="col-md-6 col-lg-6 col-xl-4">
                                        <div className="rounded position-relative fruite-item">
                                            <div className="fruite-img">
                                                <img src={img9} className="img-fluid w-100 rounded-top" alt=""/>
                                            </div>
                                            <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{top: '10px; left: 10px'}}>Fruits</div>
                                            <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Banana</h4>
