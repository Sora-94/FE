  ...
  const submitOrder = async () => {
    ...
    try {
      const response = await fetch(
        "https://be-gu7h.onrender.com/api/v1/Order",
        {
          method: "POST",
          headers: {
    ...
    <>
      ...
      <div className="container-fluid py-5">
        <div className="container py-5">
          <h1 className="mb-4">Chi tiến háo đơn</h1>
          <form onSubmit={handleSubmit}>
            <div className="row g-5">
              <div className="col-md-12 col-lg-6 col-xl-6">
                ...
                <div className="form-item">
                  <label className="form-label my-3">
                    Phương thức thanh toán<sup>*</sup>
                  </label>
                  <div className="form-check">
                    <input
                      ...
                      id="shipCOD"
                    />
                    <label className="form-check-label" htmlFor="shipCOD">
                      Ship COD
                    </label>
                  </div>
                </div>
              ...
              <div className="col-md-12 col-lg-6 col-xl-6">
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="py-5"></td>
                        <td className="py-5"></td>
                        <td className="py-5">Phí giao hàng:</td>
                      ...
                      <tr>
                        ...
                        <td className="py-5"></td>
                        <td className="py-5"></td>
                        <td className="py-5">Thành tiền:</td>
                ...
                <div className="bg-light rounded p-4">
                  ...
                  <div className="d-flex justify-content-between">
                    <h6 className="mb-3">Tổng tiền</h6>
                    <p className="mb-3">{formatCurrency(subtotal)}</p>
                  </div>
                  <div className="d-flex justify-content-between">
                    <h6 className="mb-3">Phí giao hàng</h6>
                    <p className="mb-3">{formatCurrency(shipping)}</p>
                  </div>
                  <hr />
                  <div className="d-flex justify-content-between">
                    <h6 className="mb-3">Thành tiền</h6>
